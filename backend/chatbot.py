...
try:
    classifier = joblib.load('c:/Users/LENOVO LOQ/Desktop/Chat bot/model/emotion_model_chatbot.pkl')
    vectorizer = joblib.load('c:/Users/LENOVO LOQ/Desktop/Chat bot/model/vectorizer.pkl')
    with open('c:/Users/LENOVO LOQ/Desktop/Chat bot/model/emotions_mapping.json', 'r') as f:
...
genai.configure(api_key="AIzaSyCFakbrtI4TAfxobp_cGd4A04ELVD7NgnA")
try:
