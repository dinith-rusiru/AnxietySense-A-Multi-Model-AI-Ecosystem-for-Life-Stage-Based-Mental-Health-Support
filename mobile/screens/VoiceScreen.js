...
//           <Text style={styles.resultText}>
//             Gender: <Text style={styles.bold}>{result.gender.toUpperCase()}</Text>
//           </Text>
...
//                 This application is only for pregnant women.
//               </Text>
//               <TouchableOpacity
//                 style={styles.retryBtn}
...
//   bold: { fontWeight: "700" },
//   blockText: { color: "#DC2626", marginTop: 15, textAlign: "center" }
// });
