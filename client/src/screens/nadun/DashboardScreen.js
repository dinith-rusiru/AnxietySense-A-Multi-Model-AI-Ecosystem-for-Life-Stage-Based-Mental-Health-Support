...
//   const todaysActivities = anxietyActivities[finalLevel] || [];
...
//         {anxietyHistory.map((level, index) => (
//           <Text key={index} style={styles.progress}>
//             Record {index + 1}: {level}
//           </Text>
//         ))}
//       </View>
...
//           Activities Available Today: {todaysActivities.length}
//         </Text>
//       </View>
