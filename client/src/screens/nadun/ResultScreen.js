...
// // Utility to convert score to anxiety level
...
//     const normalizedQ = (questionnaireScore / 63) * 100; // normalize questionnaire to 0-100
//     finalScore = 0.6 * normalizedQ + 0.4 * emotionScore; // weighted average
//   } else {
...
// export default function ResultScreen({ route, navigation }) {
//   const { emotion, emotionScore, questionnaireScore } = route.params;

//   // Compute final anxiety level
...
//       <TouchableOpacity
//         style={styles.button}
//         onPress={() => navigation.navigate("Activities", { finalLevel })} >
