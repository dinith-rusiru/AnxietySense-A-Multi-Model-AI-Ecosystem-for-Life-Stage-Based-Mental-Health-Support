...
export default function InstructionScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        • First, upload a short voice sample{`\n`}
        • The system will analyze your emotion{`\n`}
        • Then you may answer the questionnaire (optional){`\n`}
        • Please use a clear voice recording
      </Text>
      ...
      >
        <Text style={styles.buttonText}>Start Voice Check</Text>
      </TouchableOpacity>
    </View>
  );
}
